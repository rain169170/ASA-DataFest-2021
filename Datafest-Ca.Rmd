...
model1 <- glm(total_misuse ~ DEM_GENDER + DEM_ABOR + DEM_LOCATION + DEM_MARITAL + DEM_INCOME + DEM_EDU + ALC_FREQ_USE + TOB_FREQ_USE + OTH_RX_DRUG_USE, family=poisson, data = dataca)
summary(model1)
